...
Mitt game of life består av en grid gjort med hjälp av en jagged array. Arrayen tar in typen cell, som är en klass jag gjort. inuti klassen finns olika funktioner och variabler som används för att instansiera varje cell, kolla regler samt anropa reglerna när det behövs.
